...
export default async function SharePage({
  ...
  return (
    <div className="lg:col-span-2 order-1 lg:order-2 max-w-7xl mx-auto px-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl dark:border-gray-700 overflow-hidden">
        <div
          className={`p-4 sm:p-5 bg-gradient-to-r  border-b border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3`}
        >
        ...
        <div className="p-4 sm:p-6 md:p-8 pb-0">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <div className="whitespace-pre-wrap text-sm sm:text-base">
              <MDXContent source={data.Markdown} />
            </div>
          </div>
        </div>
      </div>
