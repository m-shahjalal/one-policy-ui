 ...
 * or first right-pinned column to apply specific shadow-smeffects.
 *
 ...
 * @param options.withBorder - Whether to show a box shadow-smbetween pinned and scrollable columns.
...
export function getCommonPinningStyles<TData>({
  ...
  column: Column<TData>;
  /**
   * Show box shadow-smbetween pinned and scrollable columns.
   * @default false
   */
  withBorder?: boolean;
}): React.CSSProperties {
