...
import { cn, toSentenceCase } from "../utils/utils";
...
export function DataTableSortList<TData>({
  ...
  return (
    <Sortable
      ...
      getItemValue={(item: ExtendedColumnSort<TData>) => item.id}
    >
      <Popover>
        ...
        >
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button
                              ...
                              variant="outline"
                              size="sm"
                              className="h-8 w-44 justify-between rounded-smfocus:outline-hidden focus:ring-1 focus:ring-ring"
                              onPointerDown={(event) => {
                            ...
                            >
                              ...
                              <div className="ml-auto flex items-center gap-1">
                                {initialSorting[0]?.id === sort.id ? (
                                  <Badge
                                    variant="secondary"
                                    className="h-[1.125rem] rounded-smpx-1 font-mono font-normal text-[0.65rem]"
                                  >
                                    Default
                                  </Badge>
                                ) : null}
          ...
          <div className="flex w-full items-center gap-2">
            <Button
              ...
              onClick={onAddSort}
              disabled={uniqueSorting.length >= sortableColumns.length}
            >
              Add sort
            </Button>
            {uniqueSorting.length > 0 ? (
