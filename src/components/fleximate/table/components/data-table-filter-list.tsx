...
import { dataTableConfig } from "../utils/config";
import {
...
import { customAlphabet } from "../utils/custom-alphabet";
...
export function DataTableFilterList<TData>({
      ...
      if (filter.operator === "isEmpty" || filter.operator === "isNotEmpty") {
        return (
          <div
            ...
            className="h-8 w-full rounded-smborder border-dashed"
          />
        );
      }
            ...
            >
              <FacetedTrigger asChild>
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="w-full rounded-smpx-1.5"
                >
                  <FacetedBadgeList
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  ...
                  size="sm"
                  className={cn(
                    "h-8 w-full justify-start rounded-smtext-left font-normal focus:rounded-hidden focus:ring-1 focus:ring-ring",
          ...
          return (
            ...
            >
              <SelectTrigger
                ...
                className="h-8 w-full rounded-smbg-transparent"
              >
  ...
  return (
    <Sortable
      value={filters}
      getItemValue={(item: Filter<TData>) => item.filterId}
      onMove={({
        activeIndex,
        overIndex,
      }: {
      ...
      <Popover>
        ...
        >
                    ...
                    >
                      ...
                      >
                          ...
                          {index === 0 ? (
                            ...
                            >
                              <SelectTrigger
                                ...
                                className="h-8 rounded-smlowercase"
                              >
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button
                              ...
                              className="h-8 w-32 justify-between rounded-smfocus:outline-hidden focus:ring-1 focus:ring-ring"
                              onPointerDown={(event) => {
                                const target = event.target;
                                if (!(target instanceof Element)) return;
                                if (target.hasPointerCapture(event.pointerId)) {
                        ...
                        <Button
                          ...
                          variant="outline"
                          size="icon"
                          className="size-8 shrink-0 rounded-sm[&>svg]:size-3.5"
          ...
          <div className="flex w-full items-center gap-2">
            <Button
              size="sm"
              className="h-[1.85rem] rounded-sm"
              onClick={onFilterAdd}
            >
              Add filter
            </Button>
